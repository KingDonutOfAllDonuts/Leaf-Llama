...
const Careers = () => {
  const [formData, setFormData] = useState({ email: "", password: "", name: "", vegetable: "", whyVegetable: "", });
  ...
  return (
    <div className={`w-full relative flex flex-col ${fadeIn ? "opacity-100" : "opacity-0"} transition-opacity duration-1000`}>
      ...
      <div className="flex flex-col items-center">
        ...
        >
          ...
          >
            Application failed, check your email, it may be in use or the server may be down.
          </span>
          : ''}
          </div>
            <button
